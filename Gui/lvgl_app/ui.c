...
///////////////////// FUNCTIONS ////////////////////
static void ui_event_PanelUserInfo(lv_event_t* e) {
//    lv_event_code_t event = lv_event_get_code(e);
//    lv_obj_t* ta = lv_event_get_target(e);
}
static void ui_event_PanelUser(lv_event_t* e) {
    lv_event_code_t event = lv_event_get_code(e);
//    lv_obj_t* ta = lv_event_get_target(e);
...
static void ui_event_RollerSelectPage(lv_event_t* e) {
    lv_event_code_t event = lv_event_get_code(e);
//    lv_obj_t* ta = lv_event_get_target(e);
...
static void ui_event_ButtonSelectPageCancel(lv_event_t* e) {
    lv_event_code_t event = lv_event_get_code(e);
//    lv_obj_t* ta = lv_event_get_target(e);
...
static void ui_event_ButtonSelectPageSure(lv_event_t* e) {
    lv_event_code_t event = lv_event_get_code(e);
//    lv_obj_t* ta = lv_event_get_target(e);
    if (event == LV_EVENT_CLICKED) {
        _ui_flag_modify(ui_PanelSelectPage, LV_OBJ_FLAG_HIDDEN, _UI_MODIFY_FLAG_ADD);
...
static void ui_event_LabelPage(lv_event_t* e) {
    lv_event_code_t event = lv_event_get_code(e);
//    lv_obj_t* ta = lv_event_get_target(e);
    if (event == LV_EVENT_CLICKED) {
...
static void ui_event_LabelMore(lv_event_t* e) {
    lv_event_code_t event = lv_event_get_code(e);
//    lv_obj_t* ta = lv_event_get_target(e);
    if (event == LV_EVENT_CLICKED) {
...
static void ui_event_LabelReturn(lv_event_t* e) {
    lv_event_code_t event = lv_event_get_code(e);
//    lv_obj_t* ta = lv_event_get_target(e);
    if (event == LV_EVENT_CLICKED) {
...
static void ui_event_TextAreaUserName(lv_event_t* e) {
    lv_event_code_t event = lv_event_get_code(e);
//    lv_obj_t* ta = lv_event_get_target(e);
    if (event == LV_EVENT_FOCUSED) {
...
static void ui_event_TextAreaRest(lv_event_t* e) {
    lv_event_code_t event = lv_event_get_code(e);
//    lv_obj_t* ta = lv_event_get_target(e);
    if (event == LV_EVENT_FOCUSED) {
        Change_Keyboard_targerTextarea(e);
...
static void ui_event_TextAreaNumber(lv_event_t* e) {
    lv_event_code_t event = lv_event_get_code(e);
//    lv_obj_t* ta = lv_event_get_target(e);
    if (event == LV_EVENT_FOCUSED) {
        Change_Keyboard_targerTextarea(e);
...
static void ui_event_ButtonClearHis(lv_event_t* e) {
    lv_event_code_t event = lv_event_get_code(e);
//    lv_obj_t* ta = lv_event_get_target(e);
    if (event == LV_EVENT_CLICKED) {
        ClearHistory(e);
...
void ui_Screen1_screen_init(void) {
    ...
    lv_obj_clear_flag(ui_PanelUserInfo,LV_OBJ_FLAG_CLICK_FOCUSABLE| LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_GESTURE_BUBBLE |
    ...
    lv_obj_add_event_cb(ui_PanelUserInfo, ui_event_PanelUserInfo, LV_EVENT_ALL, NULL);
    ...
    for (uint8_t i = 0; i < 4; i++) {
        ...
        lv_bar_set_range(uiList_UserBlock[i].bar_speed, 0, 100);
        lv_bar_set_value(uiList_UserBlock[i].bar_speed, 100, LV_ANIM_OFF);  //

        lv_obj_set_height(uiList_UserBlock[i].bar_speed, 18);
        lv_obj_set_width(uiList_UserBlock[i].bar_speed, lv_pct(100));

        lv_obj_set_x(uiList_UserBlock[i].bar_speed, 0);
        lv_obj_set_y(uiList_UserBlock[i].bar_speed, lv_pct(0));

        lv_obj_set_align(uiList_UserBlock[i].bar_speed, LV_ALIGN_RIGHT_MID);

        lv_obj_clear_flag(uiList_UserBlock[i].bar_speed,
        ...
        lv_label_set_text(uiList_UserBlock[i].lb_speed, "123.2L/Min");
        ...
        lv_bar_set_range(uiList_UserBlock[i].bar_total, 0, 100);
        lv_bar_set_value(uiList_UserBlock[i].bar_total, 50, LV_ANIM_OFF);
        ...
        lv_obj_clear_flag(uiList_UserBlock[i].bar_total,
                          LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_CLICK_FOCUSABLE |
                              LV_OBJ_FLAG_GESTURE_BUBBLE | LV_OBJ_FLAG_SNAPPABLE);
        ...
        lv_obj_set_style_bg_opa(uiList_UserBlock[i].bar_total, 255,
                                LV_PART_INDICATOR | LV_STATE_DEFAULT);
        lv_obj_set_style_bg_grad_color(uiList_UserBlock[i].bar_total, lv_color_hex(0xF61F1F),
                                       LV_PART_INDICATOR | LV_STATE_DEFAULT);
        ...
        lv_label_set_text(uiList_UserBlock[i].lb_total, "123.2L");
    ...
    lv_obj_set_height(ui_RollerSelectPage, lv_pct(80));

    lv_obj_set_x(ui_RollerSelectPage, lv_pct(0));
    lv_obj_set_y(ui_RollerSelectPage, lv_pct(7));
    ...
    lv_label_set_text(ui_LabelMore, "More");
...
void ui_Screen2_screen_init(void) {
    ...
    lv_label_set_text(ui_LabelRest, "水余量");
    ...
    lv_label_set_text(ui_Label3, "手机号码");
    ...
    lv_label_set_text(ui_Label4, "清除记录");
