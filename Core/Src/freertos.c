...
uint32_t Task_ScreenBuffer[ 550 ];
...
//    vTaskDelete(NULL);
    ...
    while (1) {
        ...
        printf("%lu\tTask_ExtiHandle\n", uxTaskGetStackHighWaterMark(Task_ExtiHandle));
        printf("%lu\tTask_ScreenHandle\n", uxTaskGetStackHighWaterMark(Task_ScreenHandle));
        printf("%lu\tTask_Air724RxHandle\n", uxTaskGetStackHighWaterMark(Task_Air724RxHandle));
        printf("%lu\tTask_Air724TxHandle\n", uxTaskGetStackHighWaterMark(Task_Air724TxHandle));
    }
